...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1729764421049.612";
}
var DashboardData = () => {
  _s();
  ...
  const fetchWeatherData = async (city2) => {
    ...
    try {
      ...
      console.error(...oo_tx(`3831350304_21_6_21_58_11`, "Error fetching weather data:", error));
    }
  };
  const fetchCityByCoordinates = async (lat, lon) => {
    ...
    try {
      ...
      console.error(...oo_tx(`3831350304_35_6_35_65_11`, "Error fetching city by coordinates:", error));
    }
  };
  const getUserLocation = () => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition((position) => {
        ...
        console.error(...oo_tx(`3831350304_48_10_48_62_11`, "Error getting user location:", error));
        setCity("London");
      });
    } else {
      console.error(...oo_tx(`3831350304_53_6_53_68_11`, "Geolocation is not supported by this browser."));
      setCity("London");
    }
  };
...
//# sourceMappingURL=/build/routes/dashboard._index-OCTZUMMV.js.map
